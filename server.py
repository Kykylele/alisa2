...
cities = {
    'москва': ['1521359/0bd57551e8c3cd5b71d3', '965417/003efa27384633609ca0'],
    'нью-йорк': ['997614/101e5d781b1cec54396b', '997614/272015079531f6fd0fcc'],
    'париж': ["13200873/64a96bf3328097d51452", '1030494/a614bea9cd5d2bda8e69']
}
    ...
    if sessionStorage[user_id]['first_name'] is None:
        ...
        if not sessionStorage[user_id]['game_started']:
            if 'помощь' in req['request']['nlu']['tokens']:
                res['response']['text'] = 'Я тебе показываю картинки городов, а ты их угадываешь'
